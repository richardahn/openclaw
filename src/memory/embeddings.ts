...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Install or satisfy node-llama-cpp in the same install prefix as OpenClaw after installing or updating OpenClaw; reinstalling OpenClaw alone will not restore this optional peer."
      : null,
